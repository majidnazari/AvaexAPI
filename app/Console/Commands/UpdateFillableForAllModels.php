...
class UpdateFillableForAllModels extends Command
{
    protected $signature = 'model:update-fillable-all';
    protected $description = 'Update the $fillable property of all models with all columns from their respective database tables';
